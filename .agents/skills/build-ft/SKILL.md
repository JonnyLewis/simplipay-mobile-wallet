---
name: build-ft
description: Drive a feature through the gated SDLC. Codex wrapper for the shared build-ft workflow.
---
...
- Use Codex subagents for bounded SDLC phases when available and useful.
