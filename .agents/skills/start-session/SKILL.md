---
name: start-session
description: Bootstrap a new Codex session by reading shared repo context and confirming the next action. Codex wrapper for the shared start-session workflow.
---
...
- Load the root `AGENTS.md` through the root `AGENTS.md` import.
