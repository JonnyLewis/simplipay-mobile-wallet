---
name: update-context
description: Create, refresh, split, and prune per-directory context files (AGENTS.md + AGENTS.md shims) based on what changed since the last sync. Codex wrapper for the shared update-context workflow.
---
...
- Always write the `AGENTS.md` content file and its one-line `AGENTS.md` shim together.
